 export const style={
    ...
    categorydiv:'flex  gap-4 justify-center m-auto mt-8',
    heading:' font-bold text-xl text-primary text-center mb-4',
    table:'w-full border-collapse border rounded-lg overflow-hidden',
    td:'"py-2 px-4 border-b',
    tr:"even:bg-gray-100 text-center",
    tbtn:'inline text-primary cursor-pointer',
    ...
    active:'bg-primary text-white px-8 py-2 rounded-full',
    btnmenunars:'bg-gray-300 font-bold  px-8 py-2 rounded-full',
